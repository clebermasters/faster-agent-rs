---
name: bedrock-models
description: Tracks AWS Bedrock model availability and detects new model releases. Scrapes AWS documentation and maintains historical data.
homepage: https://docs.aws.amazon.com/bedrock/latest/userguide/models-supported.html
metadata: {"openfangbot":{"emoji":"🤖","requires":{"bins":["python3"],"packages":["requests","beautifulsoup4","pandas"],"env":[]}}}
---
